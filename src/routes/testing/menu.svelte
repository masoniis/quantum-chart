...
<main class="min-h-screen bg-yellow-200">
	<br /><br /><br /><br /><br />

	<header class="fixed w-full py-2 bg-green-200">
		<nav class="mx-auto max-w-screen-2xl px-8">
			...
			<!-- Dropdown Menu -->
			<div class="z-0 text-center bg-red-700 text-gray-500 hover:text-black">
				<div
					class="bg-white inline-flex items-center text-base font-medium focus:outline-none hover:cursor-pointer unselectable"
				...
				{#if dropdown}
					<div
						class="fixed left-0 right-0 z-10 transform shadow-lg w-screen"
