...
<main class="min-h-screen text-maintext">
	...
	<section class="bg-gray-200 py-16">
		<flex class="flex flex-row justify-between mx-auto container">
			<h2
				class="text-6xl h-fit sticky overflow-hidden min-w-fit top-[88px] text-left font-bold tracking-tight text-gray-900 sm:leading-none"
			>
				Our mission
			</h2>
	...
	<section>
		<div class="flex justify-center">
			<div class="flex-col mx-20 xl:px-10 w-50">
				...
				<h3 class="text-2xl text-center font-bold text-gray-700">John</h3>
				<p>
